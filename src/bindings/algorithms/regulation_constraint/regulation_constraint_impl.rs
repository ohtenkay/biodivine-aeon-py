use crate::{
    bindings::{
        lib_bdd::bdd::Bdd,
        lib_param_bn::{
            regulatory_graph::RegulatoryGraph, symbolic::symbolic_context::SymbolicContext,
            NetworkVariableContext,
        },
    },
    AsNative,
};
use pyo3::{pyclass, pymethods, types::PyDict, Bound, PyAny, PyResult, Python};
